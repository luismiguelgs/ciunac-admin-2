...
| `API-REP-001` | `GET /solicitudes/reporte-fechas?inicio=:fecha&fin=:fecha&tipo=n|7` | reporte por periodo con `observaciones?: string|null`; frontend restringe tipos `1..6` o `7` |
